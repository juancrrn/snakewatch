document.addEventListener("DOMContentLoaded", () => {
    ...
    if(ROOMVISIBILITY == 'PRIVATE'){
        ...
        inviteFriendsButton.onclick = () => {
            ...
            function roomGo(){
                go("/rooms/get_user_friends/" + ROOM, 'GET', {})
                .then(d => {
                    ...
                    if(d.userFriends.length==0){
                        let NofriendsP = document.createElement('p');
                        NofriendsP.innerHTML = "No Friends to Invitate or they're just in the room!!!";
                        NofriendsP.setAttribute("class", "col-12 text-center fs-3 fw-bold");
                        userFriendsModalBody.appendChild(NofriendsP);
                    }
